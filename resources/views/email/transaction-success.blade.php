    ...
    <div style="background-color:#e4e6eb;" lang="und" dir="auto">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:180px;">
                                                                <img alt=""
                                                                    src="{{ url('frontend/images/nomads_logo.png') }}"
                    ...
                    <tr>
                        <td
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="border-bottom:2px dashed #eee;vertical-align:middle;" width="100%">
                                    <tbody>
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    Hai {{ $data->user->name }}! <br /><br /> Tiket digital kamu telah
                                                    berhasil
                                                    dicetak. <br /> Booking ID <strong>#{{ $data->id }}</strong>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td align="center"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#F27B32" role="presentation"
                                                                style="border:none;border-radius:5px;cursor:auto;mso-padding-alt:10px 25px;background:#F27B32;"
                                                                valign="middle">
                                                                <a href="{{ url('checkout/' . $data->id) }}"
                                                                    style="display:inline-block;background:#F27B32;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:5px;">
                                                                    View Details </a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
        ...
        <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:25px;text-align:center;">
                            <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
                            <div class="mj-column-per-100 mj-outlook-group-fix"
                                style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td align="left"
                                                ...
                                                <div
                                                    ...
                                                    Butuh bantuan lebih lanjut? <br /><br />
                                                    <strong>support@nomadsbyliant.com</strong>
                                                    <br />
                                                    <strong>0852-2367-8644</strong>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div
                                                    style="font-family:assistant, helvetica, arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#888B93;">
                                                    2024 Nomads by Liant Copyright. All Right Reserved.</div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
